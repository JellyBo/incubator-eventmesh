...
public abstract class AbstractStorageSQL implements StorageSQL {
    ...
    public String insertSQL(String tableName) {
        ...
        stringBuffer.append("insert info ").append(tableName).append(
                "(cloud_event_id,cloud_event_topic,cloud_event_storage_node_address,cloud_event_type,"
                        + "cloud_event_producer_group_name,cloud_event_source,cloud_event_content_type,"
                        + "cloud_event_tag,cloud_event_extensions,cloud_event_data)")
